    ...
    <main className="pt-20 relative font-sans text-gray-dark">
      ...
      <section className="relative bg-teal-neutral py-12 lg:py-20 overflow-hidden">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6">
          ...
          {/* CTA Button */}
          <div className="text-center">
            <button className="group relative bg-teal-primary text-white px-10 py-4 rounded-xl font-semibold overflow-hidden transition-all duration-300 hover:shadow-xl hover:bg-teal-dark hover:-translate-y-0.5 inline-flex items-center gap-3">
